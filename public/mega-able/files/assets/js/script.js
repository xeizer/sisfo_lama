...
$("#styleSelector").append(
    "" +
        ...
        '<span class="text-center f-18 m-t-15 m-b-15 d-block">SMK Negeri 7 Pontianak</span>' +
        '<a href="https://www.facebook.com/OfficialSMKN7PTK" target="_blank" class="btn btn-facebook soc-icon m-b-20 waves-effect waves-light"><i class="fa fa-facebook"></i></a>' +
        '<a href="https://smkn7ptk.sch.id" target="_blank" class="btn m-l-20 m-b-20 waves-effect waves-light"><img src="gambar/logo/android-icon-48x48.png"></a>' +
        "</li>" +
        "</ul>" +
        ""
);
