...
<head>
    ...
    <!--[if lt IE 10]>
      ...
      <link rel="icon" href="{{asset('gambar/logo/favicon-96x96.png')}}" type="image/x-icon">
      <!-- Google font-->
                    ...
                    <!-- Authentication card start -->
                        ...
                        <form class="md-float-material form-material" method="POST" action="{{ route('login') }}">
                            ...
                            <div class="text-center">
                                <img src="{{asset('gambar/logo/logo.png')}}" width="40%" alt="logo.png">
                            </div>
                            <div class="auth-box card">
                                <div class="card-block">
                                    ...
                                    <div class="form-group form-primary">
                                        ...
                                        <label class="float-label">Username atau NISN Anda</label>
                                    </div>
                                    <div class="form-group form-primary">
                                    ...
                                    <div class="row m-t-30">
                                        <div class="col-md-12">
                                            <button type="submit" class="btn btn-primary btn-md btn-block waves-effect waves-light text-center m-b-20 prosesloading">Sign in</button>
                                        </div>
                                    </div>
                                    <hr/>
                                    <div class="row">
...
<!-- Mirrored from html.phoenixcoded.net/mega-able/default/auth-normal-sign-in.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 27 Jun 2019 06:37:12 GMT -->
</html>
